...
export class ReactionsService {
    ...
    public apiChatsChatIdMessagesMessageIdReactionsEmojiPost(chatId: string, messageId: string, emoji: string, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: undefined, context?: HttpContext, transferCache?: boolean}): Observable<any> {
        ...
        if (messageId === null || messageId === undefined) {
            throw new Error('Required parameter messageId was null or undefined when calling apiChatsChatIdMessagesMessageIdReactionsEmojiPost.');
        }
        if (emoji === null || emoji === undefined) {
            throw new Error('Required parameter emoji was null or undefined when calling apiChatsChatIdMessagesMessageIdReactionsEmojiPost.');
        }
        ...
        let localVarPath = `/api/chats/${this.configuration.encodeParam({name: "chatId", value: chatId, in: "path", style: "simple", explode: false, dataType: "string", dataFormat: "uuid"})}/messages/${this.configuration.encodeParam({name: "messageId", value: messageId, in: "path", style: "simple", explode: false, dataType: "string", dataFormat: "uuid"})}/reactions/${this.configuration.encodeParam({name: "emoji", value: emoji, in: "path", style: "simple", explode: false, dataType: "string", dataFormat: undefined})}`;
